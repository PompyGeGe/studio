...
export const courses: Course[] = [
  {
    ...
    teacher: '于歆杰 - 清华大学',
    platform: '学堂在线',
    imageId: 'https://picsum.photos/seed/circuit/400/250',
    category: '电路分析基础',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '华成英 - 清华大学',
    platform: '学堂在线',
    imageId: 'https://picsum.photos/seed/analog/400/250',
    category: '模拟电子技术',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '郑君里 - 上海交通大学',
    platform: '中国大学MOOC',
    imageId: 'https://picsum.photos/seed/signal/400/250',
    category: '数字信号处理',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '周佳社 - 西安交通大学',
    platform: '智慧树',
    imageId: 'https://picsum.photos/seed/embedded/400/250',
    category: '嵌入式系统设计',
    status: '未开课',
  ...
  },
  {
    ...
    teacher: '周志华 - 南京大学',
    platform: '中国大学MOOC',
    imageId: 'https://picsum.photos/seed/machine-learning/400/250',
    category: '机器学习导论',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '陈越/何钦铭 - 浙江大学',
    platform: '中国大学MOOC',
    imageId: 'https://picsum.photos/seed/data-structure/400/250',
    category: '高级数据结构',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '向勇/陈渝 - 清华大学',
    platform: '学堂在线',
    imageId: 'https://picsum.photos/seed/os/400/250',
    category: '操作系统原理',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '湖科大教书匠',
    platform: 'Bilibili',
    imageId: 'https://picsum.photos/seed/network/400/250',
    category: '计算机网络原理',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '郑莉 - 清华大学',
    platform: '学堂在线',
    imageId: 'https://picsum.photos/seed/cpp/400/250',
    category: '程序设计',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '陈鄞 - 哈尔滨工业大学',
    platform: '中国大学MOOC',
    imageId: 'https://picsum.photos/seed/compiler/400/250',
    category: '编译原理',
    status: '未开课',
  ...
  },
  {
    ...
    teacher: '“爱课程”团队',
    platform: '爱课程',
    imageId: 'https://picsum.photos/seed/physics/400/250',
    category: '物理学',
    status: '已开课',
