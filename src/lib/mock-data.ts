...
export const courses: Course[] = [
  {
    ...
    teacher: '于歆杰 - 清华大学',
    platform: '学堂在线',
    imageId: 'https://images.unsplash.com/photo-1517420704952-d9f39e95b41e?q=80&w=400&h=250&fit=crop',
    category: '电路分析基础',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '华成英 - 清华大学',
    platform: '学堂在线',
    imageId: 'https://images.unsplash.com/photo-1617863954368-70020c615e47?q=80&w=400&h=250&fit=crop',
    category: '模拟电子技术',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '周佳社 - 西安交通大学',
    platform: '智慧树',
    imageId: 'https://images.unsplash.com/photo-1550439062-609e1531270e?q=80&w=400&h=250&fit=crop',
    category: '嵌入式系统设计',
    status: '未开课',
  ...
  },
  {
    ...
    teacher: '陈越/何钦铭 - 浙江大学',
    platform: '中国大学MOOC',
    imageId: 'https://images.unsplash.com/photo-1550645612-83f5d594b671?q=80&w=400&h=250&fit=crop',
    category: '高级数据结构',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '湖科大教书匠',
    platform: 'Bilibili',
    imageId: 'https://images.unsplash.com/photo-1526374965328-5f61d25c16c6?q=80&w=400&h=250&fit=crop',
    category: '计算机网络原理',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '郑莉 - 清华大学',
    platform: '学堂在线',
    imageId: 'https://images.unsplash.com/photo-1509966756634-9c23dd6e6815?q=80&w=400&h=250&fit=crop',
    category: '程序设计',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '陈鄞 - 哈尔滨工业大学',
    platform: '中国大学MOOC',
    imageId: 'https://images.unsplash.com/photo-1542831371-29b0f74f9713?q=80&w=400&h=250&fit=crop',
    category: '编译原理',
    status: '未开课',
  ...
  },
  {
    ...
    teacher: '“爱课程”团队',
    platform: '爱课程',
    imageId: 'https://picsum.photos/seed/college-physics/400/250',
    category: '物理学',
    status: '已开课',
