...
export const courses: Course[] = [
  {
    ...
    teacher: '于歆杰 - 清华大学',
    platform: '学堂在线',
    imageId: 'https://picsum.photos/seed/circuit-analysis/400/250',
    category: '电路分析基础',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '华成英 - 清华大学',
    platform: '学堂在线',
    imageId: 'https://picsum.photos/seed/analog-electronics/400/250',
    category: '模拟电子技术',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '周佳社 - 西安交通大学',
    platform: '智慧树',
    imageId: 'https://picsum.photos/seed/embedded-systems/400/250',
    category: '嵌入式系统设计',
    status: '未开课',
  ...
  },
  {
    ...
    teacher: '陈越/何钦铭 - 浙江大学',
    platform: '中国大学MOOC',
    imageId: 'https://picsum.photos/seed/data-structures/400/250',
    category: '高级数据结构',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '湖科大教书匠',
    platform: 'Bilibili',
    imageId: 'https://picsum.photos/seed/computer-networks/400/250',
    category: '计算机网络原理',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '郑莉 - 清华大学',
    platform: '学堂在线',
    imageId: 'https://picsum.photos/seed/cpp-programming/400/250',
    category: '程序设计',
    status: '已开课',
  ...
  },
  {
    ...
    teacher: '陈鄞 - 哈尔滨工业大学',
    platform: '中国大学MOOC',
    imageId: 'https://picsum.photos/seed/compiler-principles/400/250',
    category: '编译原理',
    status: '未开课',
