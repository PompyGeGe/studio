...
export default function CourseCard({ course }: CourseCardProps) {
    ...
    return (
        <Card className="group flex flex-col overflow-hidden rounded-lg border-none bg-card shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
